"""
Django settings for courseplat project.
...
SECRET_KEY = 'django-insecure-w)o75-#rb$(1&#87n*@c&x^+&zi5o!$g7_$qutf2y8--pe*n#7'
...
WSGI_APPLICATION = 'courseplat.wsgi.application'
